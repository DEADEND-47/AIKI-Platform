...
export function SkeletonRow() {
  return (
    <div className="flex gap-4 p-4 border-b border-surface-border animate-pulse">
      <div className="h-4 bg-surface-border rounded w-1/3" />
      <div className="h-4 bg-surface-border rounded w-1/6" />
      <div className="h-4 bg-surface-border rounded w-1/12" />
      <div className="h-4 bg-surface-border rounded w-1/6" />
...
export function SkeletonCard() {
  return (
    <div className="p-5 bg-surface-card border border-surface-border rounded-md space-y-4 animate-pulse">
      <div className="h-5 bg-surface-border rounded w-1/4" />
...
export function SkeletonTable({ rows = 5 }) {
  return (
    <div className="border border-surface-border rounded-md bg-surface-card overflow-hidden">
      <div className="h-10 bg-surface border-b border-surface-border" />
